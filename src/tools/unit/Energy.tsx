...
const UNITS = [
  ...
  { key: "kJ", name: "Kilojoule (kJ)", factor: 1_000 },
  { key: "MJ", name: "Megajoule (MJ)", factor: 1_000_000 },
  { key: "cal", name: "Calorie (cal)", factor: 4.184 },
  { key: "kcal", name: "Kilocalorie (kcal)", factor: 4_184 },
  { key: "Wh", name: "Watt-hour (Wh)", factor: 3_600 },
  { key: "kWh", name: "Kilowatt-hour (kWh)", factor: 3_600_000 },
  { key: "BTU", name: "BTU (IT)", factor: 1_055.05585262 },
  { key: "eV", name: "Electronvolt (eV)", factor: 1.602176634e-19 },
];

export default function Energy({ dict }: { dict: Dictionary }) {
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-[1fr_220px] gap-3 items-end">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium block">{dict.tools.unit.energy}</label>
          <select
            value={src.key}
